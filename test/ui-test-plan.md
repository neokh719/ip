...
⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⣬⣂⢅⠢⣡⢑⢐⠔⡨⢋⠿⠿⠿⠿⠿⡻⡚⢏⠫⡑⡡⣊⣤⣷⣽⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⣦⣥⣢⣡⣂⣅⣅⣣⣑⣔⣬⣶⣿⣾⣾⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿
Hi hi! I'm Plana, your cheerful task buddy!
...
bye
____________________________________________________________
Bye-bye! Keep being awesome, okay?
____________________________________________________________
```
...
mark 1
____________________________________________________________
Amazing work! You've completed this task:
  [D][X] submit report (by: Oct 15 2019)
____________________________________________________________
unmark 1
____________________________________________________________
No worries at all! Plans can change, so I've marked this task as not done:
  [D][ ] submit report (by: Oct 15 2019)
____________________________________________________________
bye
____________________________________________________________
...
client edit C1 /phone 98765432 /notes ""
____________________________________________________________
All set! I've updated this client:
  [C1] Alice Tan <alice@example.com>
____________________________________________________________
client view C1
____________________________________________________________
...
client delete C1
____________________________________________________________
All set! I've removed this client:
  [C1] Alice Tan <alice@example.com>
